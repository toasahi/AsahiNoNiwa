...
import { g as getBlogs, $ as $$Layout } from "./_blogId_.astro.adf4acc2.mjs";
      ...
      (blog) => renderTemplate`<article class="flex flex-col gap-1 sm:gap-2">
          <figure>
            <a${addAttribute(blog.id, "href")}>
              <img${addAttribute(blog.eyecatch.url, "src")} class="rounded-sm w-full h-full object-cover shadow-md aspect-[16/9]" alt="技術画像">
            </a>
          </figure>
